...
public class BusAdapter(context: Context, placeList: ArrayList<PlacesModel>) : RecyclerView.Adapter<BusAdapter.BusViewHolder>() {
    ...
    public class BusViewHolder(itemView : View) : RecyclerView.ViewHolder(itemView) {
