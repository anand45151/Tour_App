...
public class FlightAdapter(context: Context, placeList: ArrayList<PlacesModel>) : RecyclerView.Adapter<FlightAdapter.FlightViewHolder>() {
    ...
    public class FlightViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
